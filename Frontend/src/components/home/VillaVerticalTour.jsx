...
const villaFeatures = [
    { src: "/media/villa_entrance_facade.webp", title: "The Grand Estate" },
    { src: "/media/outdoor_lounge_canopy.webp", title: "Outdoor Lounge" },
    { src: "/media/kids_play_zone_overview.webp", title: "Gardens" },
];
...
const VillaVerticalTour = () => {
    ...
    return (
        <div ref={triggerRef} className="relative h-screen overflow-hidden transition-colors duration-300">
            {/* Sticky Header */}
            <div className="absolute top-4 md:top-24 left-0 w-full z-20 flex justify-center pointer-events-none px-4">
                <h2
                    ref={headerRef}
